...
const travel__itemTitleButton = document.querySelectorAll('.travel__item-title');
    ...
    butt.addEventListener('click', () => {
        for (let i = 0; i < travel__item.length; i++) {
            ...
            if (index === i) {
                ...
                wrapper[i].style.height = travel__item[i].classList.contains('travel__item_active')
                    ? ''
                    : `${heightWrapper}px`;
